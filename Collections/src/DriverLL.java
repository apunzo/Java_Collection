...
public class DriverLL 
{
	public static void main(String args[])
	{
		...
		/** Start Here Address A001=new Address("402 Comst Street","Frederick","MD","21701");
...
////////Q.1-5 ArraysList///////////////////////////////////////
		...
		while (infile.hasNextLine())
		{
			...
			int customerScore1=Integer.parseInt(infile.nextLine());
			long customerNumber1=Long.parseLong(infile.nextLine());
		...
		System.out.println(RosterOne.toString());

//////////////////////////////////////////////////////////////////////////
		/**if(debug)
		{

			Iterator<PersonalCustomer> list=RosterOne.iterator();
			

			while(list.hasNext())
			{
	
				PersonalCustomer L1=list.next();
				
				System.out.println(L1);
				/**if(L1.getLastName().equals("Lupoli")) 
				{
					RosterOne.remove("Lupoli");

				}



				else if(L1.getFirstName().contains("Becky"))
				{
					System.out.println("Found Becky");
					System.out.println(L1);

				}

				else if(L1.getFirstName().contains("Maria"))
				{
					System.out.println("Found Maria");
					System.out.println(L1);
				...
				{
					System.out.print(L1);
					System.out.println("No Maria on the list");
					System.out.println();
				}
...
///////////Q.6-9 LinkedList/////////////////////////////
		...
		while (infile2.hasNextLine())
		{
			...
			int customerScore2=Integer.parseInt(infile2.nextLine());
			long customerNumber2=Long.parseLong(infile2.nextLine());
		...
		Customer1.readFile2("./src/CustomerInfo.txt");
		
		Address A1=new Address("425 W. Woodard Blvd","Los Angeles","CA","91200");
		PersonalCustomer target=new PersonalCustomer("Ferdus","Maliki",A1,730,32508667);
		
		Address A2=new Address("2700 W. Lincoln St.","Madison","WI","53704");
		PersonalCustomer target2=new PersonalCustomer("Josh","Tesla",A2,680,87657654);
		
		
		
		
		Customer1.Roster.add(target);
		Customer1.Roster.add(target2);
		
		
		for(int i=0;i<Customer1.Roster.size();i++)
		{
			
			System.out.println(Customer1.Roster.get(i).toString());
			
			
		}
		
		System.out.println("CHECK POINT ONE\n");
...
/////////////////////////////////////////////////////////////////////////////		
		...
		//PersonalCustomer target1=new PersonalCustomer("Shawn","Lupoli",A1,720,31408767);
		
		
		
		//if(Roster2.contains(target2))
		{
			System.out.println("Found Josh");
		}
		//else
		{
			System.out.println("No Josh");
		}
		...
		for(int i=0;i<Roster2.size();i++)
		{
			...
			System.out.println(Roster2.get(i).toString());
			
		}
		
		
		
		/**Customer1.Roster.add(newCustomer);
		System.out.println(Customer1);
		Customer1.Roster.remove(newCustomer);
		System.out.println(Customer1);
	
		if(Customer1.Roster.contains("Lupoli"))
				
		{
			
			Customer1.Roster.remove("Lupoli");
			System.out.println(Customer1);
		}*/
